  ...
  return (
    <div className="animate-fadeIn">
      <div className="mb-8">
        ...
        <p className="text-gray-600">רישום כניסה ויציאה</p>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          {!isCheckedIn ? (
            <button
              ...
              disabled={loading}
              className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg text-lg"
            >
            ...
            <button
              ...
              disabled={loading}
              className="bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg text-lg"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">נוכחות החודש</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">שעות החודש</p>
              <p className="text-3xl font-bold text-gray-800">168h</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">ימים פעילים</p>
      ...
      {/* Attendance History */}
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">היסטוריית נוכחות</h3>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-right py-3 px-4 text-sm font-semibold text-gray-700">תאריך</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-gray-700">כניסה</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-gray-700">יציאה</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-gray-700">סה״כ שעות</th>
            ...
            <tbody>
              {attendanceHistory.map((record) => (
                <tr key={record.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-sm text-gray-800">{record.checkOutTime || '-'}</td>
                  <td className="py-3 px-4 text-sm text-gray-800">
